            ...
            view.setOnTouchListener(new View.OnTouchListener() {
                ...
                public boolean onTouch(View v, MotionEvent event) {
                    if (v == views[highlightedViewIndex]) {
                        viewTouch++;
                        touchPoints.setText("Points: " + viewTouch);
                        randomHighlightView();
                    }
                    return true;
                }
    ...
    private void alertDialog() {
        ...
        builder.setPositiveButton("Homepage", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                intent.putExtra("score_level1", viewTouch);
        ...
        builder.setNegativeButton("Next Level", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                Intent intent = new Intent();
                Intent intent1 = new Intent(MainActivity2.this, Score.class);
                intent.setClass(MainActivity2.this, MainActivity3.class);
                intent1.putExtra("score_level1", viewTouch);
