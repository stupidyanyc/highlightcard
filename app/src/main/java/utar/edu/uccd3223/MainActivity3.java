            ...
            view.setOnTouchListener(new View.OnTouchListener(){
                ...
                public boolean onTouch(View v, MotionEvent event) {
                    if(v == views[highlightedViewIndex]) {
                        viewTouch1++;
                        touchPoints.setText("Points: " + viewTouch1);
                        randomHighlightView();
                    }
                    return true;
                }
    ...
    private void alertDialog() {
        ...
        builder.setPositiveButton("Homepage", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                intent.putExtra("score_level2", viewTouch1);
        ...
        builder.setNegativeButton("Next Level", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                Intent intent = new Intent();
                Intent intent1 = new Intent(MainActivity3.this, Score.class);
                intent.setClass(MainActivity3.this, MainActivity4.class);
                intent1.putExtra("score_level2", viewTouch1);
